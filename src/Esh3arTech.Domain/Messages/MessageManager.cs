...
//        public async Task<Message> CreateOneWayMessageWithAttachmentAsync(Guid userId, string recipientPhoneNumber, string? messageContent, string base64, string type)
//        {
//            Message msgToReturn;
...
//            msgToReturn.AddAttachment(GuidGenerator.Create(), "BooName", type, $"{_configuration["Url"]!}");
